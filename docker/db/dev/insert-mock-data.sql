...
VALUES ('Alice', '$2a$10$3u.EyEw/JXTPhEQBUUJIM.gY/Nfb97gqyPYr73/JoIdeeko3IE2GG', 'alice@example.com', 11.00),
       ('Bob', '$2a$10$3u.EyEw/JXTPhEQBUUJIM.gY/Nfb97gqyPYr73/JoIdeeko3IE2GG', 'bob@example.com', 7.00),
       ('Carol', '$2a$10$3u.EyEw/JXTPhEQBUUJIM.gY/Nfb97gqyPYr73/JoIdeeko3IE2GG', 'carol@example.com', 5.00),
       ('Dave', '$2a$10$3u.EyEw/JXTPhEQBUUJIM.gY/Nfb97gqyPYr73/JoIdeeko3IE2GG', 'dave@example.com', 3.00);

INSERT INTO Sessions (session_id, user_id, created_at, last_used_at, expires_at, revoked)
VALUES (1, 1, 1750000000000, 1750001000000, 1750600000000, false),
       (2, 2, 1750000005000, 1750001200000, 1750600200000, false),
       (3, 3, 1750000010000, 1750000300000, 1750600400000, true);
...
VALUES ('Casual Table', 'Jogo relaxado, 3 rondas', 'WAITING', 1, 2, 4, 3, 60, 1750000500000),
       ('Ranked Table', 'Partida ranked, 5 rondas', 'ONGOING', 2, 2, 4, 5, 45, 1750000600000);
